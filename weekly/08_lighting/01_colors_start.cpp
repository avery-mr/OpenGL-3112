...
int main()
{
	...
	GLFWwindow* window =
		glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "0801 - Lighting - Color Start", nullptr, nullptr);
	...
	Shader lightingShader("../../../weekly/08_lighting/shaders/01_colors.vs",
		"../../../weekly/08_lighting/shaders/01_colors.fs");
